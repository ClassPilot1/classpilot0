          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="mb-4">
              ...
              <div className="relative">
                <MdPerson className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500 text-xl" />
                <input
                  type="text"
                  id="name"
            ...
            >
              {status === "loading" ? "Creating Account..." : "Create Account to ClassPilot"}
            </button>
          </form>
